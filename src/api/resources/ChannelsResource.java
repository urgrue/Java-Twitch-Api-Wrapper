...
public class ChannelsResource extends AbstractResource {
     ...
     * <p>Authenticated, required scope: {@link api.auth.Scopes#CHANNEL_READ}</p>
     *
     * @return a TwitchResponse containing the channel or an error
     * @throws IOException if an error occurs making the request
     */
     ...
     * </ul>
     * <p>Authenticated, required scope: {@link api.auth.Scopes#CHANNEL_EDITOR}</p>
     *
     * @param channelName the name of the channel
     ...
     * <p>Authenticated, required scope: {@link api.auth.Scopes#CHANNEL_STREAM}</p>
     *
     * @param channelName the name of the channel
     * @return a TwitchResponse containing the updated channel or an error
     * @throws IOException if an error occurs making the request
     ...
     * <p>Authenticated, required scope: {@link api.auth.Scopes#CHANNEL_COMMERCIAL}</p>
     *
     * @param channelName the name of the channel
     ...
     * <p>Authenticated, required scope: {@link api.auth.Scopes#CHANNEL_SUBSCRIPTIONS}</p>
     *
     * @param channelName the name of the channel
     * @param limit       the maximum number of objects in the array, maximum is 100
     * @param offset      the offset for pagination
     ...
     * <p>Authenticated, required scope: {@link api.auth.Scopes#CHANNEL_CHECK_SUBSCRIPTION}</p>
     *
     * @param channelName the name of the channel
