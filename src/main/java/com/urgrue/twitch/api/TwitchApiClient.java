...
/**
 * Enables the ability to interact with the TwitchApiClient.tv REST API.
 *
 * @author Matthew Bell
 */
public class TwitchApiClient {
    ...
    /**
     * Constructs a TwitchApiClient application instance with a set API base URL and API version number.
     *
     * @param baseUrl    the base URL of the TwitchApiClient API
     * @param apiVersion the API version number to request
     */
    public TwitchApiClient(String baseUrl, int apiVersion) {
    ...
    /**
     * Constructs a TwitchApiClient application instance.
     */
    ...
    /**
     * Get the set TwitchApiClient client ID.
     *
     * @return The TwitchApiClient client ID
     */
    ...
    /**
     * Set the TwitchApiClient client ID. Register your application on TwitchApiClient.tv to retrieve
     * a client ID.
     * <p>Passed to authorization endpoints to identify your application.</p>
     *
     * @param clientId TwitchApiClient client ID
     */
     ...
     * authenticate with the TwitchApiClient.tv servers.
     *
     ...
     * the functionality to access the <code>/channels</code> endpoints of the TwitchApiClient API.
     *
     ...
     * the functionality to access the <code>/chat</code> endpoints of the TwitchApiClient API.
     *
     ...
     * the functionality to access the <code>/games</code> endpoints of the TwitchApiClient API.
     *
     ...
     * the functionality to access the <code>/ingests</code> endpoints of the TwitchApiClient API.
     *
     ...
     * the functionality to access the root <code>/</code> endpoints of the TwitchApiClient API.
     *
     ...
     * the functionality to access the <code>/search</code> endpoints of the TwitchApiClient API.
     *
     ...
     * the functionality to access the <code>/streams</code> endpoints of the TwitchApiClient API.
     *
     ...
     * the functionality to access the <code>/teams</code> endpoints of the TwitchApiClient API.
     *
     ...
     * the functionality to access the <code>/users</code> endpoints of the TwitchApiClient API.
     *
     ...
     * the functionality to access the <code>/videos</code> endpoints of the TwitchApiClient API.
     *
